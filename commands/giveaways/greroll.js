...
exports.run = async (client, message, args) => {
	...
	if (!args[0]) {
		return message.channel.send(":x: You have to specify a valid message Ic!");
	}
	...
	client.giveawaysManager
		...
		.then(() => {
			// Success message
			message.channel.send("Giveaway rerollec!");
		})
		.catch(e => {
			if (
				e.startsWith(
				...
				message.channel.send("This giveaway is not endec!");
			} else {
				console.error(e);
...
module.exports.help = {
	...
	usage: "c!greroll <giveaway-message-ID>",
