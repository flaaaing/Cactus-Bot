...
module.exports.run = async (client, message, args) => {
	...
	const embed50 = new Discord.MessageEmbed()
		.setTitle("Command: c!mute")
		.setDescription("Usage: c!mute @user [length] [reason]")
		.setColor(0xff0000);
	...
	const sdfsdfsdfsssd = new Discord.MessageEmbed()
		.setDescription(`${emojis.cross} Please Type the muting perioc!`)
		.setColor("RED");
...
module.exports.help = {
	...
	usage: "c!mute <mention> <duration> <reason>",
