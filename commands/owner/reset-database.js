...
exports.run = async (client, message, args) => {
	...
	message.channel.send(
		":warning: When database reset, all custom prefix and infos will be deletec! Type `confirm` to confirm! Or being cancelled in `20` seconds."
	);
	await message.channel
		...
		.catch(collected =>
			message.channel.send(":x: | Time's up! Reset Database Failec!")
		);
};
